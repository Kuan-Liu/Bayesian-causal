...
\end{align}
  ...
  -  $n$ subject, $k$ visits and $M$ number of latent classes
...
-  PhD research is supported by theCanadian Institutes of HealthResearch, Doctoral ResearchAward GSD-152386
]
